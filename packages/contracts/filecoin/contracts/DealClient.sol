...
// v4 ile `BigNumber` yapisi kutuphanenin DISINA, ust seviyeye tasindi;
// eski kod `BigNumbers.BigNumber` diyordu. Ikisi de ithal edilir.
import {BigNumbers, BigNumber} from "@zondax/solidity-bignumber/src/BigNumbers.sol";
import {CBOR} from "solidity-cborutils/contracts/CBOR.sol";
import {Misc} from "@zondax/filecoin-solidity/contracts/v0.8/utils/Misc.sol";
import {FilAddresses} from "@zondax/filecoin-solidity/contracts/v0.8/utils/FilAddresses.sol";
// Bu uc fonksiyon eskiden yerel bir `Types.sol` kopyasindaydi. v4 ile
// kutuphanenin KENDISI ayni serilestiricileri sagliyor; kopya silindi.
// Boylece Filecoin CBOR bicimi degistiginde bakim bize kalmiyor.
...
contract DealClient {
    ...
    function getDealProposal(
        ...
        // v4 tip degisiklikleri: `label` artik duz string degil
        // `DealLabel{data,isString}`; epoch'lar da kullanici tanimli deger
        // tipi (`type ChainEpoch is int64`). Eski kod ikisini de duz
        // atiyordu.
    ...
    function updateActivationStatus(bytes memory pieceCid) public {
        ...
        // v4 ile `ChainEpoch` bir kullanici tanimli deger tipi oldu
        // (`type ChainEpoch is int64`), duz bir sayi degil. Karsilastirmadan
        // once acilmasi gerekir; eski kod dogrudan `> 0` diyordu.
