  ...
  return (
    <div className="fhe-results">
      <div className="accuracy-grid">
        <div className="accuracy-card" style={{ background: "var(--color-mint)" }}>
        ...
        <div className="accuracy-card" style={{ background: "var(--color-iris)", opacity: 0.9, color: "white" }}>
          <div className="eyebrow" style={{ color: "white" }}>ŞİFRELİ (FHE) MODEL DOĞRULUĞU</div>
          <div className="accuracy-card__value">{(fhe_accuracy * 100).toFixed(1)}%</div>
          <div className="accuracy-card__label" style={{ color: "white" }}>Zama Concrete ML</div>
        </div>
        
        <div className="accuracy-card" style={{ background: accuracy_drop > 0 ? "var(--color-meringue)" : "var(--color-seafoam)" }}>
      ...
      <div className="card" style={{ padding: "24px 0", overflowX: "auto" }}>
        <div style={{ padding: "0 24px 16px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <div className="tag" style={{ background: "var(--color-bone)" }}>{total_participants} Katılımcı</div>
        </div>
